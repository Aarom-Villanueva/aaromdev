...
import { Server, Monitor, Database, Cloud, Workflow, Boxes } from 'lucide-react';
import { capabilities } from '@/data/capabilities';

const icons = [Monitor, Server, Database, Workflow, Boxes, Cloud];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <Reveal delay={0.05}>
          <h2 className="text-headline text-white mb-20 max-w-3xl">
            Las herramientas son soporte.
            <br />
            <span className="text-white/50">La capacidad de resolver es el punto de partida.</span>
          </h2>
        </Reveal>
